...
import hr.from.ivantoplak.recipeapp.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Autowired
    public RecipeBootstrap(CategoriesRepository categoriesRepository, RecipesRepository recipesRepository, UnitsOfMeasureRepository unitsOfMeasureRepository) {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        recipesRepository.saveAll(getRecipes());
    ...
    private List<Recipes> getRecipes() {
        ...
        //get UOMs
        Optional<UnitsOfMeasure> eachUomOptional = unitsOfMeasureRepository.findByDescription("Each");

        if (!eachUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitsOfMeasure> tableSpoonUomOptional = unitsOfMeasureRepository.findByDescription("Tablespoon");

        if (!tableSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitsOfMeasure> teaSpoonUomOptional = unitsOfMeasureRepository.findByDescription("Teaspoon");

        if (!teaSpoonUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitsOfMeasure> dashUomOptional = unitsOfMeasureRepository.findByDescription("Dash");

        if (!dashUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitsOfMeasure> pintUomOptional = unitsOfMeasureRepository.findByDescription("Pint");

        if (!pintUomOptional.isPresent()) {
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitsOfMeasure> cupsUomOptional = unitsOfMeasureRepository.findByDescription("Cup");
        ...
        //get optionals
        UnitsOfMeasure eachUom = eachUomOptional.get();
        UnitsOfMeasure tableSpoonUom = tableSpoonUomOptional.get();
        UnitsOfMeasure teaSpoonUom = teaSpoonUomOptional.get();
        UnitsOfMeasure dashUom = dashUomOptional.get();
        UnitsOfMeasure pintUom = dashUomOptional.get();
        UnitsOfMeasure cupsUom = cupsUomOptional.get();

        //get Categories
        Optional<Categories> americanCategoryOptional = categoriesRepository.findByDescription("American");

        if (!americanCategoryOptional.isPresent()) {
            throw new RuntimeException("Expected Category Not Found");
        }

        Optional<Categories> mexicanCategoryOptional = categoriesRepository.findByDescription("Mexican");
        ...
        guacRecipe.addIngredient(new Ingredients("Cilantro", new BigDecimal(2), tableSpoonUom, guacRecipe));
        ...
        //Yummy Tacos
        Recipes tacosRecipe = new Recipes();
        ...
        tacosRecipe.addIngredient(new Ingredients("packed baby arugula", new BigDecimal(3), cupsUom));
        ...
        tacosRecipe.addIngredient(new Ingredients("cherry tomatoes, halved", new BigDecimal(".5"), pintUom));
        ...
        tacosRecipe.addIngredient(new Ingredients("cup sour cream thinned with 1/4 cup milk", new BigDecimal(4), cupsUom));
