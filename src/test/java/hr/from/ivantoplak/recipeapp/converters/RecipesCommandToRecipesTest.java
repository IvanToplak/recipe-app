...
public class RecipesCommandToRecipesTest {
    ...
    private RecipesCommandToRecipes converter;
    ...
    public void setUp() {
        ...
        converter = new RecipesCommandToRecipes(new CategoriesCommandToCategories(),
                new IngredientsCommandToIngredients(new UnitsOfMeasureCommandToUnitsOfMeasure()),
    ...
    public void convert() {
        ...
        CategoriesCommand category = new CategoriesCommand();
        category.setId(CAT_ID_1);

        CategoriesCommand category2 = new CategoriesCommand();
        ...
        //when
        Recipes recipe = converter.convert(recipeCommand);
        ...
        assertEquals(2, recipe.getImage().length);
    }
}